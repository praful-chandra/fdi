...
function ManagerNav({ user, selected, setSelected ,signInUser,items}) {
  const navItems = [ ...items, "change password"];
      ...
      <ul className={styles.nav}>
        {navItems.map((n, i) => (
          <li
            ...
            className={n === selected ? styles.navActive : ''}
          >
            {n}
          </li>
        ))}
...
export default connect(null,{signInUser})(ManagerNav);
