  ...
  return (
    <div className={styles.cardWrapper}>
      <div className={styles.cardImage}>
        <img src={`${process.env.REACT_APP_API_ROOT_URI}${product.product.images[0].thumb}`} alt="" />
      </div>
      <div className={styles.wishlist} onClick={()=>{}}>
      <FontAwesomeIcon icon={emptyHeart}  />
      </div>
      <div className={styles.cardContent} onClick={()=>window.location.replace(`/product/${product.slug}`)}>
        ...
        {
          deal ? (<div className={styles.priceBox}>
        ...
        </div>) : (<div className={styles.priceBox}>
          <div className={styles.priceBoxSellPrice}>
